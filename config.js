...
const CONFIG = {
  ...
  // ─── BUSINESS INFO ───────────────────────────────────────
  business: {
    name:      "Brendan's Pool Maintenance",
    phone:     "+27 78 652 1549",
    whatsapp:  "+27 78 652 1549",
    address:   "22 Malvina Rd, Kempton Park, South Africa",
  ...
  // ─── PAGE META / SEO ─────────────────────────────────────
  meta: {
    title:       "Brendan's Pool Maintenance — Pool services in kempton park",
    description: "Brendan's Pool Maintenance provides professional pool services in Kempton Park. 7 Google reviews. Call for a quote today.",
  ...
  // ─── CONTENT ─────────────────────────────────────────────
  content: {
    eyebrow:    "Pool services · Kempton Park & surrounds",
    heroTitle:  "Crystal-clear water — <em>all year round.</em>",
    heroLead:   "Brendan's Pool Maintenance keeps swimming pools clean, chemically balanced and fully functional across Kempton Park. Maintenance, repairs, pump and filter work — we handle it all.",
    ...
    band: {
      ...
      alt:   "Brendan's Pool Maintenance team at work in Kempton Park",
      text:  "Pool installation, maintenance and repairs — we keep your pool perfect."
    },

    // ─── AREAS BLURB ───────────────────────────────────────
    areasTitle: "Serving pools across Kempton Park and surrounds.",
    areasLead:  "We cover Kempton Park, Edenvale, Benoni and the surrounding areas. Maintenance contracts available throughout the service area.",
